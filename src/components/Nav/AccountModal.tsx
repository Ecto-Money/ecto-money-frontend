...
const AccountModal: React.FC<ModalProps> = ({ onDismiss }) => {
  ...
  const displayEshareBalance = useMemo(() => getDisplayBalance(eshareBalance), [eshareBalance]);

  const ebondBalance = useTokenBalance(ectoFinance.EBOND);
  const displayEbondBalance = useMemo(() => getDisplayBalance(ebondBalance), [ebondBalance]);
    ...
    <Modal>
      ...
      <Balances>
        ...
        <StyledBalanceWrapper>
          ...
          <StyledBalance>
            <StyledValue>{displayEbondBalance}</StyledValue>
