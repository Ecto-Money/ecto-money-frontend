...
const LPTokenHelpText: React.FC<{ bank: BankEntity }> = ({ bank }) => {
  ...
  const eshareAddr = ectoFinance.ESHARE.address;

  let pairName: string;
  let uniswapUrl: string;
  if (bank.depositTokenName.startsWith("ECTO-FTM")) {
    pairName = 'ECTO-FTM pair';
    uniswapUrl = 'https://spookyswap.finance/add/FTM/0x7a6e4e3cc2ac9924605dca4ba31d1831c84b44ae';
  } else if (bank.depositTokenName.startsWith("ESHARE-FTM")) {
    pairName = 'ESHARE-FTM pair';
    uniswapUrl = 'https://spookyswap.finance/add/FTM/' + eshareAddr;
  } else {
    pairName = "ECTO-ESHARE pair";
    uniswapUrl = 'https://spookyswap.finance/add/' + ectoAddr + '/' + eshareAddr;
  }
  return (
    <Card>
      <CardContent>
